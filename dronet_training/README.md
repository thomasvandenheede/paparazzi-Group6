...
5. Run cnn.py script in DroNet directory root
	`cd rpg_public_dronet`
	`python cnn.py --experiment_rootdir='../paparazzi-Group6/dronet_training/results' --train_dir='../paparazzi-Group6/dronet_training/training' --val_dir='../paparazzi-Group6/dronet_training/validation' --batch_size=16 --epochs=5 --log_rate=25`
	
The weights are then found in `paparazzi-Group6/dronet_training/results`	
